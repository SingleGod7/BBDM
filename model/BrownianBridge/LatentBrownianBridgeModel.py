...
class LatentBrownianBridgeModel(BrownianBridgeModel):
    def __init__(self, model_config):
        ...
        config_path = "/home/jiangyizhou/ldm_pet/configs/autoencoder/autoencoder_kl_48_48_4_multidose.yaml"
        config = OmegaConf.load(config_path)
        
        # 这里使用最新的检查点
        ckpt_path = "/home/jiangyizhou/ldm_pet/logs/2025-06-09T15-55-55_vae_48_48_4_alldose/checkpoints/last.ckpt"
    ...
    def encode(self, x, cond=True, normalize=None):
        ...
        x_latent = posterior.sample()
        x_latent = (x_latent - self.mean) / self.std
    ...
    def decode(self, x_latent, cond=True, normalize=None):
        ...
        x_latent = x_latent * self.std + self.mean
